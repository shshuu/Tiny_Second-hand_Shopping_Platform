...
from market.services import create_report, direct_room, global_room, register_user, send_message, transition_report
...
class ChatPolicyTests(TestCase):
    ...
    def test_global_chat_and_restricted_users(self):
        room=global_room(); self.assertEqual(send_message(sender=self.a,room=room,content="global").sender,self.a)
