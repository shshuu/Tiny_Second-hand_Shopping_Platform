...
urlpatterns=[
    ...
    path("", product_list, name="product_list"), path("signup/", signup, name="signup"), path("login/", SafeLoginView.as_view(), name="login"), path("logout/", LogoutView.as_view(next_page="login"), name="logout"),
    path("products/new/", product_create, name="product_create"), path("products/<uuid:public_id>/", product_detail, name="product_detail"), path("products/<uuid:public_id>/purchase/",product_purchase,name="product_purchase"), path("products/<uuid:public_id>/edit/", product_edit, name="product_edit"), path("products/<uuid:public_id>/delete/", product_delete, name="product_delete"), path("products/<uuid:public_id>/status/",product_status,name="product_status"),
    path("profile/", profile_view, name="profile"), path("mypage/", my_page, name="my_page"), path("store/", my_store, name="my_store"), path("password/", password_change, name="password_change"), path("blocks/<str:username>/", toggle_block, name="toggle_block"), path("wallet/", wallet_view, name="wallet"),
    path("chats/", chat_list, name="chat_list"), path("chats/<uuid:public_id>/", chat_room, name="chat_room"), path("chats/start/<uuid:product_id>/", start_product_chat, name="start_product_chat"),
